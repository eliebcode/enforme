...
<html>
    ...
    <body>
        ...
        <main>
            <div class="ariane">
                <a href="index.php" title="Redirection vers la page d'accueil">Accueil</a> / <a href="contact.php" title="Redirection vers la page de contact">Contact</a>
            </div>
            <!-- Section Contact -->
            <div class="annonce">
                <h1>Contactez En Forme !</h1>
                <p>Vous souhaitez nous contacter ? Utilisez le formulaire ci-dessous pour nous poser vos questions, nous y répondrons dans les plus brefs délais.</p>
            </div>
